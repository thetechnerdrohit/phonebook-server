...
import { areaController, areaValidation } from '../../modules/area';

const router: Router = express.Router();

router
  .route('/')
  .post(auth('manageArea'), validate(areaValidation.createUser), areaController.createArea)
  .get(auth('getAreas'), validate(areaValidation.getAreas), areaController.getAreas);
